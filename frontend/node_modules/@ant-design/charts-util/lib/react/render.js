        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('react-dom')); })];
                case 4:
                    legacy = _a.sent();
...
function fallbackLegacyRender(node, container) {
    if (!legacyRender)
        throw new Error('ReactDOM.render not available');
...
function render(node, container) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ensureReactDOM()];
                case 1:
                    _a.sent();
                    if (createRoot)
...
function fallbackLegacyUnmount(container) {
    if (!legacyUnmount)
        throw new Error('ReactDOM.unmountComponentAtNode not available');
